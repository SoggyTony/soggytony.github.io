...
const Timeline = () => {
    const [activeMilestone, setActiveMilestone] = useState(4); //set as the most recent milestone for default
    ...
    return (
        <div className="container timeline-container">
            ...
            <div className="timeline-bar">
                ...
                <div
                    key={i}
                    className={`container timeline-milestone ${activeMilestone === i ? "active" : ""}`}
